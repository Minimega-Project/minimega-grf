...
public enum SpeedDirection {
	STATIC(Direction.UP, false, true),
	NATURAL(Direction.UP, true, true),
	NORTH(Direction.NORTH, false),
	SOUTH(Direction.SOUTH, false),
	EAST(Direction.EAST, false),
	WEST(Direction.WEST, false),
	OMNI_NORTH(Direction.NORTH, true),
	OMNI_SOUTH(Direction.SOUTH, true),
	OMNI_EAST(Direction.EAST, true),
	OMNI_WEST(Direction.WEST, true);
	private final boolean omni;
	private final Direction direction;
	private final boolean special;

	SpeedDirection(Direction direction, boolean omni) {
		this(direction, omni, false);
	}

	SpeedDirection(Direction direction, boolean omni, boolean special) {
