...
public final class WaitForOnAction extends ACElement implements Effect {
	public WaitForOnAction(List<Element> children) {
		super(children);
	}
	@Override
	public String getId() {
		return "WaitForOnAction";
	}

	public static class Type implements ACType<WaitForOnAction> {
		@Override
		public WaitForOnAction parseSelf(org.w3c.dom.Element element, List<Element> children) {
			return new WaitForOnAction(children);
		}

		@Override
		public org.w3c.dom.Element serializeSelf(
				Document document,
				WaitForOnAction self,
