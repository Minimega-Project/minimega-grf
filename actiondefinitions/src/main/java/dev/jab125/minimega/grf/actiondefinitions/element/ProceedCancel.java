...
public final class ProceedCancel extends ACElement implements Effect {
	public ProceedCancel(List<Element> children) {
		super(children);
	}
	@Override
	public String getId() {
	...
	public static class Type implements ACType<ProceedCancel> {
		@Override
		public ProceedCancel parseSelf(org.w3c.dom.Element element, List<Element> children) {
			return new ProceedCancel(children);
		}
