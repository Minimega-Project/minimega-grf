...
public final class StopAll extends ACElement implements Effect {
	public StopAll(List<Element> children) {
		super(children);
	}
	@Override
	public String getId() {
	...
	public static class Type implements ACType<StopAll> {
		@Override
		public StopAll parseSelf(org.w3c.dom.Element element, List<Element> children) {
			return new StopAll(children);
		}
