...
public final class Cancel extends ACElement {
	public Cancel(List<Element> children) {
		super(children);
	}
	@Override
	public String getId() {
	...
	public static class Type implements ACType<Cancel> {
		@Override
		public Cancel parseSelf(org.w3c.dom.Element element, List<Element> children) {
			return new Cancel(children);
		}
