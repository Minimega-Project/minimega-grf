...
public final class ActionDefinitions extends ACElement {
	public ActionDefinitions(List<Element> children) {
		super(children);
	}
	...
	public static class Type implements ACType<ActionDefinitions> {
		@Override
		public ActionDefinitions parseSelf(org.w3c.dom.Element element, List<Element> children) {
			return new ActionDefinitions(children);
		}

		@Override
		public org.w3c.dom.Element serializeSelf(
				Document document,
				ActionDefinitions self,
