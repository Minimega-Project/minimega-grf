...
public final class PreviousNamedArea extends ACElement implements ITrigger {

	public final String namedArea;

	public PreviousNamedArea(String namedArea, List<Element> children) {
		super(children);
	...
	public static class Type implements ACType<PreviousNamedArea> {
		@Override
		public PreviousNamedArea parseSelf(org.w3c.dom.Element element, List<Element> children) {
			return new PreviousNamedArea(unindent(element.getTextContent()), children);
		}

		@Override
		public org.w3c.dom.Element serializeSelf(
				Document document,
				PreviousNamedArea self,
