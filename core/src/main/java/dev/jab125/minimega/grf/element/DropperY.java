...
public final class DropperY extends Element {
	public double y;

	public DropperY(double y, List<Element> children) {
		super(children);
		this.y = y;
	}
	...
	static class Type implements ElementType<DropperY> {
		@Override
		public DropperY parseSelf(org.w3c.dom.Element element, List<Element> children) {
			return new DropperY(Double.parseDouble(element.getAttribute("y")), children);
		}
		...
		public org.w3c.dom.Element serializeSelf(
			...
			element.setAttribute("y", Double.toString(self.y));
