...
public final class DialogSequence extends ACElement implements Effect {
	public DialogSequence(List<Element> children) {
		super(children);
	}
	@Override
	public String getId() {
	...
	public static class Type implements ACType<DialogSequence> {
		@Override
		public DialogSequence parseSelf(org.w3c.dom.Element element, List<Element> children) {
			return new DialogSequence(children);
		}
