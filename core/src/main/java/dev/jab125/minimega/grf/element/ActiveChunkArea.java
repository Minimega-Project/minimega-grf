...
public final class ActiveChunkArea extends Element {
	public final int x0, x1, z0, z1;

	public ActiveChunkArea(int x0, int x1, int z0, int z1, List<Element> children) {
		super(children);
		this.x0 = x0;
		this.x1 = x1;
		this.z0 = z0;
	...
	public ActiveChunkArea(String x0, String x1, String z0, String z1, List<Element> children) {
		this(parseInt(x0), parseInt(x1), parseInt(z0), parseInt(z1), children);
	}
	...
	@Override
	public String getId() {
		return "ActiveChunkArea";
	}

	static class Type implements ElementType<ActiveChunkArea> {
		@Override
		public ActiveChunkArea parseSelf(org.w3c.dom.Element element, List<Element> children) {
			return new ActiveChunkArea(element.getAttribute("x0"), element.getAttribute("x1"), element.getAttribute("z0"), element.getAttribute("z1"), children);
		}

		@Override
		public org.w3c.dom.Element serializeSelf(
				Document document,
				ActiveChunkArea self,
