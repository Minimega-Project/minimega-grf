...
public final class All extends ACElement implements ITrigger {
	public All(List<Element> children) {
		super(children);
	}
	...
	public static class Type implements ACType<All> {
		@Override
		public All parseSelf(org.w3c.dom.Element element, List<Element> children) {
