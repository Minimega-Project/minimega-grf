...
public final class ExitDialogSequence extends ACElement implements Effect {
	public ExitDialogSequence(List<Element> children) {
		super(children);
	}
	@Override
	public String getId() {
		return "ExitDialogSequence";
	}

	public static class Type implements ACType<ExitDialogSequence> {
		@Override
		public ExitDialogSequence parseSelf(org.w3c.dom.Element element, List<Element> children) {
			return new ExitDialogSequence(children);
		}

		@Override
		public org.w3c.dom.Element serializeSelf(
				Document document,
				ExitDialogSequence self,
