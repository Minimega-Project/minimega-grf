...
public final class OnActions extends ACElement {
	public OnActions(List<Element> children) {
		super(children);
	}
	...
	public static class Type implements ACType<OnActions> {
		@Override
		public OnActions parseSelf(org.w3c.dom.Element element, List<Element> children) {
			return new OnActions(children);
		}
