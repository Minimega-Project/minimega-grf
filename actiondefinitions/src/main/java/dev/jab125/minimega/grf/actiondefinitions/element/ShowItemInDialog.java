...
public final class ShowItemInDialog extends ACElement implements Effect {

	public final String text;

	public ShowItemInDialog(String text, List<Element> children) {
		super(children);
		this.text = text;
	}
	...
	public static class Type implements ACType<ShowItemInDialog> {
		@Override
		public ShowItemInDialog parseSelf(org.w3c.dom.Element element, List<Element> children) {
			return new ShowItemInDialog(unindent(element.getTextContent()).strip(), children);
		}

		@Override
		public org.w3c.dom.Element serializeSelf(
				Document document,
				ShowItemInDialog self,
