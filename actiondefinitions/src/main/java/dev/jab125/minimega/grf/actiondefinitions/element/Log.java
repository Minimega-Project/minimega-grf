...
public final class Log extends ACElement implements Effect {

	public final String text;

	public Log(String text, List<Element> children) {
		super(children);
		this.text = text;
	}
	...
	public static class Type implements ACType<Log> {
		@Override
		public Log parseSelf(org.w3c.dom.Element element, List<Element> children) {
			return new Log(unindent(element.getTextContent()).strip(), children);
		}
