...
public final class FistfightFlag extends Element {
	public int flag;

	public FistfightFlag(int flag, List<Element> children) {
		super(children);
		this.flag = flag;
	}
	...
	@Override
	public String getId() {
		return "FistfightFlag";
	}

	static class Type implements ElementType<FistfightFlag> {
		@Override
		public FistfightFlag parseSelf(org.w3c.dom.Element element, List<Element> children) {
			return new FistfightFlag(Integer.parseInt(element.getAttribute("flag")), children);
		}
		...
		public org.w3c.dom.Element serializeSelf(
			...
			element.setAttribute("flag", Integer.toString(self.flag));
