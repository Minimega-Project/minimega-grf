...
public final class MapOptions extends Element {
	public int themeId;

	public MapOptions(int y, List<Element> children) {
		super(children);
		this.themeId = y;
	}
	...
	static class Type implements ElementType<MapOptions> {
		@Override
		public MapOptions parseSelf(org.w3c.dom.Element element, List<Element> children) {
			String themeId1 = element.getAttribute("themeId");
			return new MapOptions(themeId1.isBlank() ? 0 : Integer.parseInt(themeId1), children);
		}
		...
		public org.w3c.dom.Element serializeSelf(
			...
			element.setAttribute("themeId", Integer.toString(self.themeId));
