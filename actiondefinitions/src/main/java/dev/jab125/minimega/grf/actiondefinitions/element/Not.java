...
public final class Not extends ACElement implements ITrigger {
	public Not(List<Element> children) {
		super(children);
	}
	...
	public static class Type implements ACType<Not> {
		@Override
		public Not parseSelf(org.w3c.dom.Element element, List<Element> children) {
