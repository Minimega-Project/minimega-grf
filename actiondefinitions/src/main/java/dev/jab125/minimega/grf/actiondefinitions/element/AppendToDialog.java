...
public final class AppendToDialog extends ACElement implements Effect {

	public final String text;

	public AppendToDialog(String text, List<Element> children) {
		super(children);
		this.text = text;
	}
	...
	@Override
	public String getId() {
		return "AppendToDialog";
	}

	public static class Type implements ACType<AppendToDialog> {
		@Override
		public AppendToDialog parseSelf(org.w3c.dom.Element element, List<Element> children) {
			return new AppendToDialog(unindent(element.getTextContent()).strip(), children);
		}
