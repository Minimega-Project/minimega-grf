...
public final class EnteredNamedArea extends ACElement implements OnAction {
	public EnteredNamedArea(List<Element> children) {
		super(children);
	}

	@Override
	public String getId() {
		return "EnteredNamedArea";
	}

	public static class Type implements ACType<EnteredNamedArea> {
		@Override
		public EnteredNamedArea parseSelf(org.w3c.dom.Element element, List<Element> children) {
			return new EnteredNamedArea(children);
		}

		@Override
		public org.w3c.dom.Element serializeSelf(
				Document document,
				EnteredNamedArea self,
