...
public sealed interface Effect permits AppendToDialog, CloseDialog, ContinueText, Delay, Dialog, DialogSequence, ExitDialogSequence, HardcodedStatusMessage, Log, PopulateAllContainersInsideOfNamedArea, ProceedCancel, StopAll, WaitForOnAction {
