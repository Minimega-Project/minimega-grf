...
public final class TargetArea extends Element {
	public final String name;
	public final int x0, x1, y0, y1, z0, z1;

	public TargetArea(String name, int x0, int x1, int y0, int y1, int z0, int z1, List<Element> children) {
		super(children);
		this.name = name;
		this.x0 = x0;
		this.x1 = x1;
	...
	// TODO PRIMARY
	public TargetArea(String name, String x0, String x1, String y0, String y1, String z0, String z1, List<Element> children) {
		this(name, parseInt(x0), parseInt(x1), parseInt(y0), parseInt(y1), parseInt(z0), parseInt(z1), children);
	}
	...
	static class Type implements ElementType<TargetArea> {
		@Override
		public TargetArea parseSelf(org.w3c.dom.Element element, List<Element> children) {
			return new TargetArea(element.getAttribute("name"), element.getAttribute("x0"), element.getAttribute("x1"), element.getAttribute("y0"), element.getAttribute("y1"), element.getAttribute("z0"), element.getAttribute("z1"), children);
		}
