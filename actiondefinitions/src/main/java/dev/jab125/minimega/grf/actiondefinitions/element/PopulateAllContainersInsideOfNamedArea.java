...
public final class PopulateAllContainersInsideOfNamedArea extends ACElement implements Effect {
	public PopulateAllContainersInsideOfNamedArea(List<Element> children) {
		super(children);
	}
	@Override
	public String getId() {
		return "PopulateAllContainersInsideOfNamedArea";
	}

	public static class Type implements ACType<PopulateAllContainersInsideOfNamedArea> {
		@Override
		public PopulateAllContainersInsideOfNamedArea parseSelf(org.w3c.dom.Element element, List<Element> children) {
			return new PopulateAllContainersInsideOfNamedArea(children);
		}

		@Override
		public org.w3c.dom.Element serializeSelf(
				Document document,
				PopulateAllContainersInsideOfNamedArea self,
