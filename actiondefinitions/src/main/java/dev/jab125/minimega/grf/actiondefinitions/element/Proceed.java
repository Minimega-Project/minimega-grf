...
public final class Proceed extends ACElement {
	public Proceed(List<Element> children) {
		super(children);
	}
	@Override
	public String getId() {
	...
	public static class Type implements ACType<Proceed> {
		@Override
		public Proceed parseSelf(org.w3c.dom.Element element, List<Element> children) {
			return new Proceed(children);
		}
