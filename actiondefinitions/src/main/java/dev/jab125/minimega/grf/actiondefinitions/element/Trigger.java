...
public final class Trigger extends ACElement {
	public Trigger(List<Element> children) {
		super(children);
	}
	...
	public static class Type implements ACType<Trigger> {
		@Override
		public Trigger parseSelf(org.w3c.dom.Element element, List<Element> children) {
