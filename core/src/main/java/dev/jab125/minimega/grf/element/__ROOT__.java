...
public final class __ROOT__ extends Element {
	public __ROOT__(List<Element> children) {
		super(children);
	}

	public MapOptions getMapOptions() {
		return this.getFirstOf(MapOptions.class).orElseThrow();
	}

	public LevelRules getLevelRules() {
		return this.getFirstOf(LevelRules.class).orElseThrow();
	}
	...
	static class Type implements ElementType<__ROOT__> {
		@Override
		public __ROOT__ parseSelf(org.w3c.dom.Element element, List<Element> children) {
			return new __ROOT__(children);
		}
