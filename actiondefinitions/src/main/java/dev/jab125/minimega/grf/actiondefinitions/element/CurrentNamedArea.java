...
public final class CurrentNamedArea extends ACElement implements ITrigger {

	public final String namedArea;

	public CurrentNamedArea(String namedArea, List<Element> children) {
		super(children);
	...
	@Override
	public String getId() {
		return "CurrentNamedArea";
	}

	public static class Type implements ACType<CurrentNamedArea> {
		@Override
		public CurrentNamedArea parseSelf(org.w3c.dom.Element element, List<Element> children) {
			return new CurrentNamedArea(unindent(element.getTextContent()), children);
		}

		@Override
		public org.w3c.dom.Element serializeSelf(
				Document document,
				CurrentNamedArea self,
				List<org.w3c.dom.Element> children
		) {
			org.w3c.dom.Element element = document.createElement(self.getId());
			element.setTextContent(self.namedArea);
