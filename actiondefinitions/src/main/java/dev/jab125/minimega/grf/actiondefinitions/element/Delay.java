...
public final class Delay extends ACElement implements Effect {
	public Delay(List<Element> children) {
		super(children);
	}
	@Override
	public String getId() {
	...
	public static class Type implements ACType<Delay> {
		@Override
		public Delay parseSelf(org.w3c.dom.Element element, List<Element> children) {
			return new Delay(children);
		}
